               ...
               <h1 className="text-2xl font-bold text-center mb-6 text-black">
                  ...
                  <form onSubmit={handleSignup} className="space-y-4">
                      ...
                      <div>
                         ...
                         <input id="email" type="email" value={email}  onChange={(e) => setEmail(e.target.value)} required className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-black" placeholder="you@example.com"/>
